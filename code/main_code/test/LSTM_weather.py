...
##########################################
def main(path, target, seq_length, name, epochs, learning_rate, hidden_size, num_layers):
    ...
    model = LSTM(hidden_size=hidden_size, num_layers=num_layers).to(device)
    criterion = nn.MSELoss()
    optimizer = torch.optim.Adam(model.parameters(), lr=learning_rate)

    train_model = lstm_train(name, model, train_loader, optimizer, criterion, epochs, device)
    forecast = lstm_eval(train_model, scaler, test_loader, device, criterion)
...
forecast, actual = main(path, target, seq_length, name, epochs, learning_rate, hidden_size, num_layers)